...
namespace Crafty.Controllers
{
    public class RegisteredUsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,name,address,subscriptionCost,totalSubscriptionCost,productDemographic")] RegisteredUser registeredUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,name,address,subscriptionCost,totalSubscriptionCost,productDemographic")] RegisteredUser registeredUser)
        {
            if (ModelState.IsValid)
            {
